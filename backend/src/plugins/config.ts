...
const ConfigSchema = Type.Strict(
  Type.Object({
    ...
    ADMIN_ROUTES_ENABLED: Type.Boolean() || undefined,
    ...
    DELETE_KEY_RECOVER_WINDOW: Type.Optional(Type.Number()),
    KMS_KEY_ID: Type.Optional(Type.String()) || undefined,
    USE_KMS: Type.Boolean() || false,
    DEFAULT_BUNDLER_API_KEY: Type.String(),
    MULTI_TOKEN_PAYMASTERS: Type.Optional(Type.String()),
    MULTI_TOKEN_ORACLES: Type.Optional(Type.String()),
...
const configPlugin: FastifyPluginAsync = async (server) => {
  ...
  const envVar = {
    ...
    ADMIN_ROUTES_ENABLED: process.env.ADMIN_ROUTES_ENABLED,
  ...
  const config = {
    ...
    ADMIN_ROUTES_ENABLED: process.env.ADMIN_ROUTES_ENABLED === 'true',
